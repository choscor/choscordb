...
if(CHOSCORDB_ENABLE_SANITIZERS)
  if(NOT CMAKE_SYSTEM_NAME MATCHES "^(Linux|Darwin)$" OR MSVC OR NOT CMAKE_CXX_COMPILER_ID MATCHES "Clang")
    message(FATAL_ERROR "CHOSCORDB_ENABLE_SANITIZERS requires Clang 23 on Linux or macOS")
  endif()
...
if(CHOSCORDB_ENABLE_COVERAGE)
  if(NOT CMAKE_SYSTEM_NAME MATCHES "^(Linux|Darwin)$" OR MSVC OR NOT CMAKE_CXX_COMPILER_ID MATCHES "Clang" OR NOT CMAKE_CXX_COMPILER_VERSION MATCHES "^23\\.")
    message(FATAL_ERROR "CHOSCORDB_ENABLE_COVERAGE requires Clang major version 23 on Linux or macOS")
  endif()
...
function(_choscordb_register_first_party_target target)
  ...
  foreach(candidate IN LISTS ARGN)
    if(candidate MATCHES "\\.(c|cc|cpp|cxx|mm)$")
...
function(choscordb_add_quality_targets usage_target)
  ...
  # Test fixture headers use Qt Test alongside the desktop's public dependencies.
  target_link_libraries(choscordb-header-check-objects PRIVATE ${usage_target} Qt6::Test)
  if(CHOSCORDB_ENABLE_STRICT_WARNINGS)
    if(MSVC)
