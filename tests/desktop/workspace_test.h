...
class WorkspaceTest : public QObject {
  ...
  private slots:
    ...
    void connectionSecurityControlsExposeSupportedVariants();
    void connectionProxySettingsRoundTripWithoutPersistingSecrets();
    void connectionProxyConflictsPreserveEditableDraft();
    void connectionSshForwardingOverridesRoundTrip();
    void sshHostKeyInspectionRequiresExplicitActionAndKeepsUiResponsive();
    void sshHostKeyReviewRequiresSelectionAndShowsExactFingerprint();
    void sshHostKeyStaleInspectionSuccessCannotOpenApproval();
    void sshHostKeyApprovalUpdatesOnlyTheSelectedHop();
    void inlineSshKeysStayMaskedAndOutsideProfileMetadata();
    void inlineHopKeysHaveIndependentActionsAndSurviveReordering();
    void sshHopEditorPreservesIndependentSecretsWhenReordered();
    void sshHopEditorKeepsAndClearsCredentialsByStableId();
    void connectionJumpHostsAllowExplicitPassphraseClearing();
    ...
    void connectionSecurityDraftRoundTripsWithoutPersistingSecrets();
    void connectionTransportValidationRejectsIncompatibleSettings();
    void connectionFormRejectsMalformedHostsBeforeSubmission();
    void mysqlConnectionFormExplainsOptionalDatabaseAndPreservesLiterals();
    ...
    void sshLocalBindingSettingsRoundTripAndWarnForWildcard();
    void sshLocalBindConflictReachesTestAndConnectAndKeepsDraft();
